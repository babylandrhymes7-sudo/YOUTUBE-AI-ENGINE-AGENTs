...
class NotificationManager:
    ...
    def _build_brief(
        ...
        *,
        ...
        title = "Daily Morning Brief" if category is NotificationCategory.DAILY_MORNING_BRIEF else "Weekly Strategy Brief"
    ...
    def _validate_message(self, message: NotificationMessage) -> list[str]:
        warnings: list[str] = []
        if message.category in {NotificationCategory.DAILY_MORNING_BRIEF, NotificationCategory.WEEKLY_STRATEGY_BRIEF}:
    ...
    def _attachment_retry_requested(self, message: NotificationMessage) -> bool:
        return message.category in {NotificationCategory.DAILY_MORNING_BRIEF, NotificationCategory.WEEKLY_STRATEGY_BRIEF} and not message.attachments and bool(message.data.get("pending_attachment_path"))
