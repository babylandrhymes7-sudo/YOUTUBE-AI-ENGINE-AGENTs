...
class NotificationEngine:
    ...
    def send_monthly_report_brief(self, report: dict[str, Any], pdf_path: str | Path | None, *, generation_seconds: float | None = None) -> NotificationOutcome:
        return self._manager.send_monthly_brief(report, pdf_path, generation_seconds=generation_seconds)

    def send_news_update(self, news_analysis: dict[str, Any]) -> NotificationOutcome:
        return self._manager.send_news_update(news_analysis)
